<div class="header-area">
  ...
  <div class="header-mid header-sticky" style="    height: 84px;
    padding: 12px 0px;
    ...
    <div class="container">
      <div class="menu-wrapper">
        <div class="logo">
          <a href="index.html">
            <img src="https://www.sportsdrive.in/images/logo.png" style="width: 158px;" alt>
          </a>
        </div>
        <div class="main-menu d-none d-lg-block">
          <!-- <nav>
            <ul id="navigation">
              ...
              <li>
                <a href="#">Pages <i class="fas fa-angle-down"></i>
                </a>
                <ul class="submenu">
                  <li>
